...
excerpt: >-
  **DigiTax Zambia API Hub** contains guides and API reference pages for further
  understanding, equipping you on how to integrate with the ZRA Smart Invoice
  System
hidden: false
---
<Cards columns={2}>
  ...
  <Card title="ZRA Smart Invoice integration with DigiTax" icon="fa-bars">
    Explore this page and other detailed guide pages to gain understanding of the ZRA Smart Invoice System and how DigiTax integration works.
  </Card>
...
<Accordion title="DigiTax is Pan-African. Explore other countries here ..." icon="fa-globe">
  ...
  * <i class="icon-guides"></i> **DigiTax Zambia API hub (You are here 🎉)**
</Accordion>
...
Once onboarded to Smart Invoice, you get to leverage the technological convenience this software solution provides.
...
The fourth one, **Certified Invoicing Systems**, involves an integration that is achieved through an interface with the Virtual Sales Data Controller (VSDC), which is a bridge between the Certified Invoicing System (CIS) and the ZRA Smart Invoice System.
...
<Image src="https://files.readme.io/7ff2aa91556d4fa8a47c8fabe6ee819c853fde6e3a8e8671b7522328afc17540-Full-Logo_Slogan_Universal.png" align="center" width="320px" caption="DigiTax" />
...
- Throttling between your business' throughput and ZRA Smart Invoice System.<br />A business only needs to send an invoice once, and DigiTax will process the information thereafter based on ZRA Smart Invoice System capacity at that particular point in time.
...
1. RESTful API
2. OpenAPI (formerly Swagger): An open-source standard that allows a standardized way to generate, document, and test our APIs.
